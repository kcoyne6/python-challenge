...
# -*- coding: utf-8 -*-
"""
    Created on Sat Mar  2 16:59:58 2019
...
# define variables for counting months and financial data
...
csvpath = os.path.join('..', 'Desktop', 'python-challenge', 'budget_data.csv')
...
# compute total profit/loss for the entire time frame
...
output_path = os.path.join("..","Desktop", "python-challenge", "PyBank", "Financial_Analysis.txt")
